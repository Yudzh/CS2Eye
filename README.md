...
Итерация 01: получение Valve World top-30 из BO3.gg.

- безопасная проверка источника без изменения БД;
- ручное обновление top-30;
- активны ровно команды текущего top-30;
...
- тренеров и ручных ролей;
- расчёта силы игроков и команд;
- демо-парсинга;
- сравнения команд;
